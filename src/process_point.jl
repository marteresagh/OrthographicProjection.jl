...
function processPoint(params::ParametersOrthophoto, point::Point)
	...
	if params.pc
		Common.update_boundingbox!(params.tightBB,vcat(Common.apply_matrix(params.ucs,position)...))
		plas = newPointRecord(point, LasIO.LasPoint2, params.mainHeader; affineMatrix = params.ucs)
