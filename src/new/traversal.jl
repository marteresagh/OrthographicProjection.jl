...
"""
function traversal(potree::String, params::OrthophotoArguments)
    println("= ")
...
Depth search first.
"""
function dfs(trie::DataStructures.Trie{String}, params::OrthophotoArguments)# due callback: 1 con controllo e 1 senza controllo
